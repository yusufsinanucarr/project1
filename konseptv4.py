...
# PDF export için gerekli kütüphaneler
try:
...
class DrawingCanvas(tk.Canvas):
    """Çizim canvası - Not sayfasının üzerine bindirilmiş"""
    ...
    def load_drawings(self, drawings):
        ...
        for drawing in drawings:
            ...
            # Diğer tipler için ekle (e.g., polygon vb.)

class NoteEditor(tk.Toplevel):
    """Gelişmiş Not Editörü - Üzerine Çizim Yapılabilir"""
    def __init__(self, parent, page_id, initial_content="", callback=None):
        ...
        # Widget to obj mapping for serialize
        self.widget_to_obj = {}
    ...
    def load_content(self, content):
        """İçeriği yükle - Optimize edilmiş"""
        try:
